...
export default function Home() {
  ...
  return (
    <div className="bg-picMain h-screen flex items-center flex-col justify-center text-lg bg-cover">
      <h1 className="text-gold text-8xl italic bold shadow-lg mb-5">Shopping list {products.length} </h1>
      <main className="bg-white border rounded-2xl shadow-lg m-15 w-screen max-w-md mt-5">
        ...
        <form onSubmit={addProduct} className="border-b-3 px-8 gap-2 flex">
          <input
            ...
            className="border-b gap-2 h-30 w-180"
